...
Ambos métodos tenían prácticamente la misma estructura, con la única diferencia real siendo el signo negativo
y el ajuste final del mismo. Haciendo este cambio dejo de mezclar responsabilidad de alto nivel con detalles
internos de recorrido y transformación.
...
He aplicado nombres mas descriptivos y que dan a entender mejor que realiza cada método y para que se va a
utilizar cada variable.

# Resumen

> He centrado la refactorización en eliminar duplicación, mejorar nombres, extraer responsabilidades a métodos
> pequeños y cohesivos, eliminar números mágicos y centralizar la lógica.
